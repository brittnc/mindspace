          ...
          <CardContent>
            ...
            <form noValidate autoComplete="off" id="symptom-form">
              <FormControl className='formControl' fullWidth>     
                ...
                <Typography className='formError' component="p">{this.props.symptomTypeError}</Typography>
              </FormControl>
              ...
              <FormControl className='formControl' fullWidth>
                ...
                />
                <Typography className='formError' component="p">{this.props.symptomDayError}</Typography>
              </FormControl>
              ...
              <FormControl className='formControl' fullWidth>
                ...
                />
                <Typography className='formError' component="p">{this.props.symptomTimeError}</Typography>
              </FormControl>
              ...
              <FormControl className='formControl' fullWidth>
                ...
                />
                <Typography className='formError' component="p">{this.props.symptomInfoError}</Typography>
              </FormControl>
              ...
              <Typography className='formSuccess' component="p">{this.props.formSuccessMessage}</Typography>
            </form>
          </CardContent>
        </Card>
      </div>
