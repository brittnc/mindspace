...
class DoctorList extends Component {
  ...
  loadClinics = () => {
    ClinicsAPI.getClinics()
      .then((res) => this.setState({ clinics: res.data }))
      .catch((err) => console.log('there is an issue loading doctors: ' + err));
  };
  ...
  handleDoctorFormSubmit = (event) => {
    ...
    if (this.state.doctorClinic === '') {
      this.setState({
        doctorClinicError:
          'From the drop-down list, select the primary clinic that the doctor is associated with.',
      });
    }
    ...
    if (this.state.doctorPhone === '') {
      ...
      DoctorsAPI.saveDoctor({
        ...
        .then((res) => this.loadDoctors())
        .catch((err) =>
          console.log('there is a problem saving doctor: ' + err)
        );
              ...
              <Grid container spacing={16}>
                <Grid item xs={12} sm={12} md={6}>
                  <DoctorForm
                    ...
                    handleDoctorFirstNameChange={
                      this.handleDoctorFirstNameChange
                    }
                    ...
                    doctorFormSuccessMessage={
                      this.state.doctorFormSuccessMessage
                    }
                  />
                </Grid>
                <Grid item xs={12} sm={12} md={6}>
              ...
              <Grid container spacing={16} className={classes.clinicSection}>
                <Grid item xs={12} sm={12} md={6}>
                  <ClinicForm
                    ...
                    clinicFormSuccessMessage={
                      this.state.clinicFormSuccessMessage
                    }
                  />
                </Grid>
                <Grid item xs={12} sm={12} md={6}>
